...
const TreeUnwrapperTestData kUnwrapModuleTestCases[] = {
        ...
        ModuleItemList(
            ...
            StatementList(
                2, N(2, L(2, {"assign", "`BIT_ASSIGN_MACRO", "("}),
                     MacroArgList(4, L(4, {"l1", ","}), L(4, {"r1"})), L(2, {")"}))),
            L(1, {"end"})),
        L(0, {"endmodule"}),
    },
    ...
    },
    {
        ...
        ModuleItemList(
            1, L(1, {"initial", "begin"}),
            StatementList(2, N(2, L(2, {"const", "var", "automatic"}),
                               L(2, {"int"}), L(2, {"a", "=", "0", ";"}))),
            L(1, {"end"})),
        L(0, {"endmodule"}),
    },
    ...
    */
...

    {
        ...
        ModuleItemList(
            1, L(1, {"case", "(", "foo", ")"}),
            CaseItemList(2, N(2, L(2, {"A", ":"}),
                              Instantiation(2, L(2, {"a", "aa", ";"})))),
            L(1, {"endcase"}), L(1, {"case", "(", "bar", ")"}),
            CaseItemList(2, N(2, L(2, {"B", ":"}),
...
const TreeUnwrapperTestData kUnwrapUvmTestCases[] = {
    {
        ...
        N(0, L(0, {"`uvm_object_utils_begin", "("}), NL(2, {"l0"}), L(0, {")"})),
        N(1, L(1, {"`uvm_field_int", "("}), N(3, L(3, {"l1a", ","}), L(3, {"UVM_DEFAULT"})), L(1, {")"})),
        N(1, L(1, {"`uvm_field_int", "("}), N(3, L(3, {"l1b", ","}), L(3, {"UVM_DEFAULT"})), L(1, {")"})),
...

    {
        ...
        N(0, L(0, {"`uvm_object_utils_begin", "("}), NL(2, {"l0"}), L(0, {")"})),
        N(1, L(1, {"`uvm_field_int", "("}), N(3, L(3, {"l1a", ","}), L(3, {"UVM_DEFAULT"})), L(1, {")"})),
        N(1, L(1, {"`uvm_object_utils_begin", "("}), NL(3, {"l1"}), L(1, {")"})),
        N(2, L(2, {"`uvm_field_int", "("}), N(4, L(4, {"l2a", ","}), L(4, {"UVM_DEFAULT"})), L(2, {")"})),
        N(2, L(2, {"`uvm_object_utils_begin", "("}), NL(4, {"l2"}), L(2, {")"})),
        N(3, L(3, {"`uvm_field_int", "("}), N(5, L(5, {"l3a", ","}), L(5, {"UVM_DEFAULT"})), L(3, {")"})),
...

    {
        ...
        "`uvm_field_int(l1b, UVM_DEFAULT)\n",
        N(0, L(0, {"`uvm_field_utils_begin", "("}), NL(2, {"l0"}), L(0, {")"})),
        N(0, L(0, {"`uvm_field_int", "("}), N(2, L(2, {"l1a", ","}), L(2, {"UVM_DEFAULT"})), L(0, {")"})),
        N(0, L(0, {"`uvm_field_int", "("}), N(2, L(2, {"l1b", ","}), L(2, {"UVM_DEFAULT"})), L(0, {")"})),
    },
...
const TreeUnwrapperTestData kClassTestCases[] = {
...

    {
        ...
        ClassItemList(1, N(1, L(1, {"`uvm_warning", "("}), L(1, {")"})),
                      N(1, L(1, {"`uvm_error", "("}), L(1, {")"})),
                      N(1, L(1, {"`uvm_func_new", "("}), L(1, {")"}))),
        L(0, {"endclass"}),
    },
...
const TreeUnwrapperTestData kUnwrapPreprocessorTestCases[] = {
...

    {
        ...
        N(0,  //
          ...
          N(2,  //
            L(2, {"MioWarl_A", ","}),
            NL(2, {"padctrl", ".", "reg2hw", ".", "mio_pads", "[", "mio_sel", "]",
                   ".", "qe", "|=>", "!", "(", "|", "padctrl", ".", "mio_attr_q",
                   "[", "mio_sel", "]", "[", "padctrl_reg_pkg", "::", "AttrDw", "-",
                   "1", ":", "2", "]", ")", ","}),
            L(2, {"clk_i", ","}),
            L(2, {"!", "rst_ni"})),
          L(0, {")"})),
    ...
    {
        "assert macro embedded in module with property_spec inside arugment list",
        "module foo;"
        "  `ASSERT("
        "      MioWarl_A,"
        "      padctrl.reg2hw.mio_pads[mio_sel].qe |=>"
        ...
        N(1,  //
          N(1,  //
            ...
            N(3,  //
              L(3, {"MioWarl_A", ","}),
              NL(3, {"padctrl", ".", "reg2hw", ".", "mio_pads", "[", "mio_sel", "]",
                     ".", "qe", "|=>", "!", "(", "|", "padctrl", ".", "mio_attr_q",
                     "[", "mio_sel", "]", "[", "padctrl_reg_pkg", "::", "AttrDw", "-",
                     "1", ":", "2", "]", ")", ","}),
              L(3, {"clk_i", ","}),
    ...
    {
        "assert macro embedded in initial block with property_spec inside argument list",
        "module foo;"
        "  initial begin"
        "    `ASSERT("
        "        MioWarl_A,"
        ...
        N(1,  //
          ...
          N(2,  //
            N(2,  //
              ...
              N(4,  //
                L(4, {"MioWarl_A", ","}),
                NL(4, {"padctrl", ".", "reg2hw", ".", "mio_pads", "[", "mio_sel", "]",
                       ".", "qe", "|=>", "!", "(", "|", "padctrl", ".", "mio_attr_q",
                       "[", "mio_sel", "]", "[", "padctrl_reg_pkg", "::", "AttrDw", "-",
                       "1", ":", "2", "]", ")", ","}),
                L(4, {"clk_i", ","}),
...
const TreeUnwrapperTestData kUnwrapTaskTestCases[] = {
...

    {
        ...
        "endtask",
        TaskHeader(0, L(0, {"task", "foo", ";"})),
        StatementList(1, DataDeclaration(1, L(1, {"static"}), L(1, {"int"}),
                                         L(1, {"return_value", ";"}))),
        L(0, {"endtask"}),
    },
...
const TreeUnwrapperTestData kUnwrapPrimitivesTestCases[] = {
    {
        ...
        "  endtable\n"
        "endprimitive",
        L(0, {"primitive", "comb", "(", "o", ",", "i", ")", ";"}),
        NL(1, {"output", "o", ";"}),
        NL(1, {"input", "i", ";"}),
        UdpBody(1, L(1, {"table"}), NL(2, {"1", ":", "0", ";"}),
                NL(2, {"0", ":", "1", ";"}), L(1, {"endtable"})),
        L(0, {"endprimitive"}),
    },
    {
        "double input UDP",
