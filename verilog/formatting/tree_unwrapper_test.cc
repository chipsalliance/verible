...
const TreeUnwrapperTestData kUnwrapModuleTestCases[] = {
...

    {
        ...
        ModuleItemList(
            ...
            Instantiation(
                1, L(1, {"foo"}),
                InstanceList(3, L(3, {"c", "("}),
                             PortActualList(5, L(5, {"x", ","}),
                                            L(5, {"y", ","}), L(5, {"z"})),
                             L(3, {")", ";"})  // TODO(fangism): attach to 'z'?
                             )),
            Instantiation(
                1, L(1, {"foo"}),
                InstanceList(
                    3, L(3, {"d", "("}),
                    PortActualList(5, L(5, {".", "x", "(", "x", ")", ","}),
                                   L(5, {".", "y", "(", "y", ")", ","}),
                                   L(5, {".", "w", "(", "z", ")"})),
                    L(3, {")", ";"}))),
            Instantiation(
...
const TreeUnwrapperTestData kUnwrapTaskTestCases[] = {
...

    {
        ...
        "endtask",
        TaskHeader(0, L(0, {"task", "foo", ";"})),
        StatementList(1, L(1, {"while", "(", "1", ")", "begin"}),
                      StatementList(2, L(2, {"$makeitso", "(", "x", ")", ";"})),
                      L(1, {"end"})),
        L(0, {"endtask"}),
    },
...
const TreeUnwrapperTestData kUnwrapFunctionTestCases[] = {
...

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"foreach", "(", "x", "[", "i", "]", ")",  //
                               "foreach", "(", "j", "[", "k", "]", ")",  //
                               "y", "=", "x", ";"})),
        L(0, {"endfunction"}),
    },
...

    {
        ...
        StatementList(
            1, L(1, {"if", "(", "zz", ")", "begin"}),
            StatementList(2, L(2, {"return", "0", ";"})), L(1, {"end"}),  //
            L(1, {"if", "(", "yy", ")", "begin"}),
...

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"if", "(", "zz", ")", "return", "0", ";"}),
                      L(1, {"if", "(", "yy", ")", "return", "1", ";"})),
        L(0, {"endfunction"}),
    },

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"if", "(", "zz", ")", "begin"}),
    ...
    /* TODO(fangism): add a non-indented partition that allows the
     * single-statement body to be attached to the entire loop construct.
    {
    ...
    */
...

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"forever", "begin"}),
                      StatementList(2, L(2, {"return", "1", ";"})),
                      L(1, {"end"})),
        L(0, {"endfunction"}),
    },

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"forever", "break", ";"})),
        L(0, {"endfunction"}),
    },

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"repeat", "(", "2", ")", "begin"}),
                      StatementList(2, L(2, {"return", "1", ";"})),
                      L(1, {"end"})),
        L(0, {"endfunction"}),
    },

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"repeat", "(", "2", ")", "continue", ";"})),
        L(0, {"endfunction"}),
    },

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"while", "(", "x", ")", "begin"}),
                      StatementList(2, L(2, {"return", "1", ";"})),
                      L(1, {"end"})),
        L(0, {"endfunction"}),
    },

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"while", "(", "e", ")", "coyote", "(",
                               "sooper_genius", ")", ";"})),
        L(0, {"endfunction"}),
    },

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"while", "(", "e", ")", "while", "(", "e", ")",
                               "coyote", "(", "sooper_genius", ")", ";"})),
        L(0, {"endfunction"}),
    },

    {
        ...
        "endfunction",
        FunctionHeader(0, L(0, {"function", "foo", ";"})),
        StatementList(1, L(1, {"do", ";", "while", "(", "y", ")", ";"})),
        L(0, {"endfunction"}),
    },
