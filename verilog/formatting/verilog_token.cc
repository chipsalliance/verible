...
static const auto* FormatTokenTypeMap =
    new absl::node_hash_map<verilog_tokentype, FTT>({
        // keywords
        ...
        {verilog_tokentype::TK_Shold, FTT::keyword},
        {verilog_tokentype::TK_Snochange, FTT::keyword},
        {verilog_tokentype::TK_Speriod, FTT::keyword},
        {verilog_tokentype::TK_Srecovery, FTT::keyword},
        {verilog_tokentype::TK_Ssetup, FTT::keyword},
        {verilog_tokentype::TK_Ssetuphold, FTT::keyword},
        {verilog_tokentype::TK_Sskew, FTT::keyword},
        {verilog_tokentype::TK_Swidth, FTT::keyword},
        ...
        {verilog_tokentype::TK_Sfullskew, FTT::keyword},
        {verilog_tokentype::TK_Srecrem, FTT::keyword},
        {verilog_tokentype::TK_Sremoval, FTT::keyword},
        {verilog_tokentype::TK_Stimeskew, FTT::keyword},
