...
absl::string_view ForbiddenAnonymousEnumsRule::Name() { return "typedef-enums"; }
...
std::string ForbiddenAnonymousEnumsRule::GetDescription(DescriptionType description_type) {
  return absl::StrCat("Checks that a Verilog ",
                      ...
                      " directive is named using",
                      Codify("typedef", description_type), ". See ",
                      GetStyleGuideCitation(kTopic), ".");
}

void ForbiddenAnonymousEnumsRule::HandleSymbol(const verible::Symbol& symbol,
