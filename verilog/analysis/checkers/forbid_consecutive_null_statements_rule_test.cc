...
TEST(ForbidConsecutiveNullStatementsRule, FunctionFailures) {
  ...
  const std::initializer_list<LintTestCase> kTestCases = {
      ...
      {"module m;\nalways_ff @(posedge foo) ;",
        {kToken, ";"}, {kToken, ";"}, " endmodule\n"},

      {"module m;\nalways_ff @(posedge foo) ; /* comment */ ",
        {kToken, ";"}, " endmodule\n"},
      {"module m;\nalways_ff @(posedge foo) ; /* comment */ ",
        {kToken, ";"}, " /* comment */ ", {kToken, ";"}, " endmodule\n"},

      {"module m;\ninitial begin end\nendmodule"},
      {"module m;\ninitial begin ; end\nendmodule"},
      {"module m;\ninitial begin ;", {kToken, ";"}, " end\nendmodule"},
      {"module m;\ninitial begin ;", {kToken, ";"}, {kToken, ";"}, " end\nendmodule"},

      {"module m;\ninitial begin for (;;) ; end\nendmodule"},
      {"module m;\ninitial begin for (;;) ;", {kToken, ";"}, " end\nendmodule"},
      {"module m;\ninitial begin for (;;) ;", {kToken, ";"},
        {kToken, ";"}, " end\nendmodule"},
      ...
      {"function foo;\nbegin for (;;) begin ;", {kToken, ";"}, " end end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin ;", {kToken, ";"},
        {kToken, ";"}, " end end\nendfunction\n"},

      {"function foo;\nbegin for (;;) begin ; end end\nendfunction ; \n"},
      {"function foo;\nbegin for (;;) begin ; end ; end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin ; end ;", {kToken, ";"}, " end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin ; end ;", {kToken, ";"},
        {kToken, ";"}, " end\nendfunction\n"},
      ...
      {"function foo;\nbegin for (;;) begin ;", {kToken, ";"},
        " end ;", {kToken, ";"}, " end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin ;", {kToken, ";"},
        " end ;", {kToken, ";"}, {kToken, ";"}, " end\nendfunction\n"},

      {"function foo;\nbegin for (;;) begin ;", {kToken, ";"},
        {kToken, ";"}, " end ; end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin ;", {kToken, ";"},
        {kToken, ";"}, " end ;", {kToken, ";"}, " end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin ;", {kToken, ";"},
        {kToken, ";"}, " end ;", {kToken, ";"}, {kToken, ";"}, " end\nendfunction\n"},

      {"function foo;\nbegin for (;;) begin for (;;) begin end end end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin for (;;) begin ; end end end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin for (;;) begin ;",
        {kToken, ";"}, " end end end\nendfunction\n"},
      {"function foo;\nbegin for (;;) begin for (;;) begin ;",
        {kToken, ";"}, {kToken, ";"}, " end end end\nendfunction\n"},
