...
//
// The right-hand side also accepts constant integers:
//  data_q  <= 0 -> OK
//  data_q3 <= 0 -> OK
//
// An extension of this rule could perform checks outside
// always_ff blocks, so that
//  assign data_q = something
//  always_comb data_q = something
//  data_d <= something
// produce warnings
//
...
//
// [1]
// https://github.com/lowRISC/style-guides/blob/master/VerilogCodingStyle.md#suffixes
class DffNameStyleRule : public verible::SyntaxTreeLintRule {
 public:
  using rule_type = verible::SyntaxTreeLintRule;
  inline static const std::string kDefaultInputSuffixes = "next,n,d";
  inline static const std::string kDefaultOutputSuffixes = "reg,r,ff,q";
