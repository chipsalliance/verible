...
TEST(GenerateLabelPrefixRuleTest, Various) {
  const std::initializer_list<LintTestCase> kTestCases = {
      ...
      {"module m;\n"
       ...
       "\nendgenerate\nendmodule\n"},
      {"module m;\n"
       "if (x) begin : ", {SymbolIdentifier, "bad_label"}, "\n"
       "end : ", {SymbolIdentifier, "bad_label"}, "\n"
       "endmodule\n"},
      ...
      {"module mod_a;\n"
       "genvar i;\n"
       "for (i=0; i<5; i=i+1) begin : ", {SymbolIdentifier, "missing_prefix"}, "\n"
       "end\n"
       "endmodule\n"},
      {"module mod_a;\n"
       "genvar i;\n"
       "for (i=0; i<5; i=i+1) begin : ", {SymbolIdentifier, "missing_prefix"}, "\n"
       "end : ", {SymbolIdentifier, "missing_prefix"}, "\n"
       "endmodule\n"},
      {"module mod_a;\n"
       "genvar i;\n"
