...
absl::string_view ForbidConsecutiveNullStatementsRule::Name() { return "forbid-consecutive-null-statements"; }
const char ForbidConsecutiveNullStatementsRule::kTopic[] = "consecutive-null-statements";
const char ForbidConsecutiveNullStatementsRule::kMessage[] =
    "Do not use consecutive null statements like \';;\'.";

std::string ForbidConsecutiveNullStatementsRule::GetDescription(DescriptionType description_type) {
  return absl::StrCat("Checks that there are no occurrences of ",
                      "consecutive null statements like ",
                      Codify(";;", description_type));
}

void ForbidConsecutiveNullStatementsRule::HandleLeaf(const verible::SyntaxTreeLeaf& leaf,
