...
TEST(MismatchedLabelsRuleTest, MismatchedLabelsTests) {
  const std::initializer_list<LintTestCase> kTestCases = {
      ...
      {"module foo;\n"
       ...
       "    for(int i=0; i<5; ++i)\n"
       "    begin : second_label\n"
       "    end : ", {SymbolIdentifier, "inv_second_label"}, "\n"
       "  end : first_label\n"
       "endmodule"},
      {"module foo;\n"
       "  initial begin : first_label\n"
       ...
       "    begin : second_label\n"
       "    end : second_label\n"
       "  end : ", {SymbolIdentifier, "inv_first_label"}, "\n"
       "endmodule"},
      {"module foo;\n"
       "  initial begin : first_label\n"
       "    for(int i=0; i<5; ++i)\n"
      ...
      {"module foo;\n"
       ...
       "    for(int i=0; i<5; ++i)\n"
       "    begin : second_label\n"
       "    end : ", {SymbolIdentifier, "first_label"}, "\n"
       "  end : ", {SymbolIdentifier, "second_label"}, "\n"
       "endmodule"},
      // end label missing
      {"module foo;\n"
       "  initial begin : first_label\n"
