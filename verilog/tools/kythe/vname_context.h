...
#ifndef VERIBLE_VERILOG_TOOLS_KYTHE_VNAME_CONTEXT_H_
#define VERIBLE_VERILOG_TOOLS_KYTHE_VNAME_CONTEXT_H_
...
#endif  // VERIBLE_VERILOG_TOOLS_KYTHE_VNAME_CONTEXT_H_
