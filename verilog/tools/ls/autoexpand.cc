...
class AutoExpander {
 public:
  ...
  std::optional<TextEdit> ExpandAutoDeclarations(
      const Module &module, const std::cmatch &match, size_t indent,
...
std::optional<TextEdit> AutoExpander::ExpandAutoDeclarations(
    const Module &module, const std::cmatch &match, const size_t indent,
  ...
  new_text << Spacer(indent) << "// Beginning of automatic " << description
           << '\n';
...
std::optional<TextEdit> AutoExpander::ExpandAutoPorts(
  ...
  auto result = ExpandAutoDeclarations(
      *module, *match, indent, description,
...
std::optional<TextEdit> AutoExpander::ExpandAutowire(
  ...
  return ExpandAutoDeclarations(
      module, *match, format_style_.indentation_spaces,
