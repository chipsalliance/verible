...
//    $foo_bar(...);
//
static constexpr LeafMatcher<SystemTFIdentifier> SystemTFIdentifierLeaf;
...
//    `MACRO();
//
static constexpr LeafMatcher<MacroCallId> MacroCallIdLeaf;
...
//
static constexpr LeafMatcher<SymbolIdentifier> SymbolIdentifierLeaf;
...
#define CONSIDER(tag) static constexpr NodeMatcher<NodeEnum::tag> Node##tag;
...
#define CONSIDER(tag)                                                \
  static constexpr verible::matcher::PathMatchBuilder<1> Path##tag = \
...
//   void'(expression());
//
static constexpr auto VoidcastHasExpression =
...
//   x = foo();
//
static constexpr auto ExpressionHasFunctionCall =
...
//
static constexpr auto ExpressionHasRandomizeCallExtension =
...
//
static constexpr auto ExpressionHasRandomizeFunction =
...
//
static constexpr auto UnqualifiedReferenceHasId =
    verible::matcher::MakePathMatcher(N(kLocalRoot), N(kUnqualifiedId),
                                      L(SymbolIdentifier));
static constexpr auto FunctionCallHasId = UnqualifiedReferenceHasId;
...
static constexpr auto NumberHasConstantWidth =
...
//   "'b" in "4'b1111"
//
static constexpr auto NumberIsBinary =
...
//   "1111" in "4'b1111"
//
static constexpr auto NumberHasBinaryDigits =
...
//   "'b1111" in "4'b1111"
//
static constexpr auto NumberHasBasedLiteral =
...
//
static constexpr auto ActualParameterListHasPositionalParameterList =
...
//   foo bar(port1, port2);
//
static constexpr auto GateInstanceHasPortList =
...
//     end
//   endgenerate
static constexpr auto HasBeginLabel =
...
static constexpr auto DisableStatementHasLabel =
...
//     c = d;
//   end
static constexpr auto AlwaysStatementHasEventControlStar =
    verible::matcher::MakePathMatcher(N(kProceduralTimingControlStatement),
                                      N(kEventControl), L('*'));

static constexpr auto AlwaysStatementHasEventControlStarAndParentheses =
    verible::matcher::MakePathMatcher(N(kProceduralTimingControlStatement),
                                      N(kEventControl), N(kParenGroup), L('*'));

static constexpr auto AlwaysStatementHasParentheses =
    verible::matcher::MakePathMatcher(N(kProceduralTimingControlStatement),
...
//  endgenerate
//
static constexpr auto HasGenerateBlock =
...
//   ... = zz::bar(...);
//
static constexpr auto RValueIsFunctionCall = verible::matcher::MakePathMatcher(
...
//   bar(...);
//
static constexpr auto FunctionCallIsQualified =
...
//
static constexpr auto FunctionCallArguments =
...
//   wire w [x:y];
//
static constexpr auto DeclarationDimensionsHasRanges =
...
//   endcase
//
static constexpr auto HasDefaultCase =
