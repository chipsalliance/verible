...
// AutoPopStack class automatically handles pushing and popping of managed stack and
// provides public read-only access to random elements of stack and iteration over
// stack elements (forward/reversed).
// It may be useful on implementing algorithms based on stack data structures like
// building inheritance stack of traversed tree.
template <typename T>
class AutoPopStack {
 public:
