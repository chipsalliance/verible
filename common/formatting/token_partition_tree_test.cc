...
class ReshapeFittingSubpartitionsTest
    : public TokenPartitionTreeTestFixture {};
...
TEST_F(ReshapeFittingSubpartitionsTest, IndentationOnePartition) {
  ...
  tree.Children()[1].ApplyPreOrder(
      [&style](TokenPartitionTree& node) {
...
class ReshapeFittingSubpartitionsTestFixture : public ::testing::Test,
                                               public UnwrappedLineMemoryHandler {
 public:
