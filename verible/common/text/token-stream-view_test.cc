...
TEST_F(TokenViewRangeTest, TokenViewRangeSpanningOffsetsNonEmpty) {
  const TokenViewRangeTestCase test_cases[] = {
      {.left_offset = 0, .right_offset = 1, .left_index = 0, .right_index = 1},
      {.left_offset = 0, .right_offset = 5, .left_index = 0, .right_index = 1},
      {.left_offset = 0, .right_offset = 6, .left_index = 0, .right_index = 2},
      {.left_offset = 0, .right_offset = 14, .left_index = 0, .right_index = 6},
      {.left_offset = 0, .right_offset = 15, .left_index = 0, .right_index = 7},
      {.left_offset = 0,
       .right_offset = 27,
       .left_index = 0,
       .right_index = 11},
      ...
      {.left_offset = 9, .right_offset = 9, .left_index = 4, .right_index = 4},
