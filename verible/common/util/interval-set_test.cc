...
TEST(IntervalSetTest, AddSingleValue) {
  ...
  const AddSingleValueTestData kTestCases[] = {
      {.value = 5, .expected = {{5, 6}, {10, 20}, {30, 40}}},
      {.value = 9, .expected = {{9, 20}, {30, 40}}},
      {.value = 10, .expected = {{10, 20}, {30, 40}}},
      {.value = 19, .expected = {{10, 20}, {30, 40}}},
      {.value = 20, .expected = {{10, 21}, {30, 40}}},
      {.value = 22, .expected = {{10, 20}, {22, 23}, {30, 40}}},
      {.value = 28, .expected = {{10, 20}, {28, 29}, {30, 40}}},
      {.value = 29, .expected = {{10, 20}, {29, 40}}},
      {.value = 30, .expected = {{10, 20}, {30, 40}}},
      {.value = 39, .expected = {{10, 20}, {30, 40}}},
      {.value = 40, .expected = {{10, 20}, {30, 41}}},
      {.value = 41, .expected = {{10, 20}, {30, 40}, {41, 42}}},
  };
...
TEST(IntervalSetTest, AddIntervalNonEmpty) {
  ...
  const AddIntervalTestData kTestCases[] = {
      {.value = {5, 9}, .expected = {{5, 9}, {10, 20}, {30, 40}}},
      {.value = {5, 10}, .expected = {{5, 20}, {30, 40}}},
      {.value = {5, 20}, .expected = {{5, 20}, {30, 40}}},
      {.value = {5, 21}, .expected = {{5, 21}, {30, 40}}},
      {.value = {5, 29}, .expected = {{5, 29}, {30, 40}}},
      {.value = {5, 30}, .expected = {{5, 40}}},
      {.value = {5, 40}, .expected = {{5, 40}}},
      {.value = {5, 41}, .expected = {{5, 41}}},
      {.value = {10, 19}, .expected = {{10, 20}, {30, 40}}},
      {.value = {10, 20}, .expected = {{10, 20}, {30, 40}}},
      {.value = {10, 21}, .expected = {{10, 21}, {30, 40}}},
      {.value = {10, 29}, .expected = {{10, 29}, {30, 40}}},
      {.value = {10, 30}, .expected = {{10, 40}}},
      {.value = {10, 40}, .expected = {{10, 40}}},
      {.value = {10, 41}, .expected = {{10, 41}}},
      {.value = {20, 21}, .expected = {{10, 21}, {30, 40}}},
      {.value = {20, 29}, .expected = {{10, 29}, {30, 40}}},
      {.value = {20, 30},
       .expected = {{10, 40}}},  // seals the gap, abutting both ends
      {.value = {20, 40}, .expected = {{10, 40}}},
      {.value = {20, 41}, .expected = {{10, 41}}},
      {.value = {21, 29}, .expected = {{10, 20}, {21, 29}, {30, 40}}},
      {.value = {21, 30}, .expected = {{10, 20}, {21, 40}}},
      {.value = {21, 40}, .expected = {{10, 20}, {21, 40}}},
      {.value = {21, 41}, .expected = {{10, 20}, {21, 41}}},
      {.value = {29, 30}, .expected = {{10, 20}, {29, 40}}},
      {.value = {29, 40}, .expected = {{10, 20}, {29, 40}}},
      {.value = {29, 41}, .expected = {{10, 20}, {29, 41}}},
      {.value = {30, 40}, .expected = {{10, 20}, {30, 40}}},
      {.value = {30, 41}, .expected = {{10, 20}, {30, 41}}},
      {.value = {40, 41}, .expected = {{10, 20}, {30, 41}}},
      {.value = {41, 42}, .expected = {{10, 20}, {30, 40}, {41, 42}}},
  };
  for (const auto &test : kTestCases) {
    UnsafeIntervalSet copy(init);
    copy.Add(test.value);
...
TEST(IntervalSetTest, DifferenceSingleValue) {
  ...
  const DifferenceSingleValueTestData kTestCases[] = {
      {.value = 9, .expected = {{10, 20}, {30, 40}}},
      {.value = 10, .expected = {{11, 20}, {30, 40}}},
      {.value = 11, .expected = {{10, 11}, {12, 20}, {30, 40}}},
      {.value = 18, .expected = {{10, 18}, {19, 20}, {30, 40}}},
      {.value = 19, .expected = {{10, 19}, {30, 40}}},
      {.value = 20, .expected = {{10, 20}, {30, 40}}},
      {.value = 21, .expected = {{10, 20}, {30, 40}}},
      {.value = 29, .expected = {{10, 20}, {30, 40}}},
      {.value = 30, .expected = {{10, 20}, {31, 40}}},
      {.value = 31, .expected = {{10, 20}, {30, 31}, {32, 40}}},
      {.value = 38, .expected = {{10, 20}, {30, 38}, {39, 40}}},
      {.value = 39, .expected = {{10, 20}, {30, 39}}},
      {.value = 40, .expected = {{10, 20}, {30, 40}}},
      {.value = 41, .expected = {{10, 20}, {30, 40}}},
  };
  for (const auto &test : kTestCases) {
...
TEST(IntervalSetTest, DifferenceIntervalNonEmpty) {
  ...
  const DifferenceIntervalTestData kTestCases[] = {
      {.value = {5, 9}, .expected = {{10, 20}, {30, 40}}},
      {.value = {5, 10}, .expected = {{10, 20}, {30, 40}}},
      {.value = {5, 11}, .expected = {{11, 20}, {30, 40}}},
      {.value = {5, 19}, .expected = {{19, 20}, {30, 40}}},
      {.value = {5, 20}, .expected = {{30, 40}}},
      {.value = {5, 21}, .expected = {{30, 40}}},
      {.value = {5, 29}, .expected = {{30, 40}}},
      {.value = {5, 30}, .expected = {{30, 40}}},
      {.value = {5, 31}, .expected = {{31, 40}}},
      {.value = {5, 39}, .expected = {{39, 40}}},
      {.value = {5, 40}, .expected = {}},
      {.value = {5, 41}, .expected = {}},
      {.value = {10, 10},
       .expected = {{10, 20}, {30, 40}}},  // ok to remove empty interval
      {.value = {10, 11}, .expected = {{11, 20}, {30, 40}}},
      {.value = {10, 19}, .expected = {{19, 20}, {30, 40}}},
      {.value = {10, 20}, .expected = {{30, 40}}},
      {.value = {10, 21}, .expected = {{30, 40}}},
      {.value = {10, 29}, .expected = {{30, 40}}},
      {.value = {10, 30}, .expected = {{30, 40}}},
      {.value = {10, 31}, .expected = {{31, 40}}},
      {.value = {10, 39}, .expected = {{39, 40}}},
      {.value = {10, 40}, .expected = {}},
      {.value = {10, 41}, .expected = {}},
      {.value = {11, 11}, .expected = {{10, 20}, {30, 40}}},
      {.value = {11, 19}, .expected = {{10, 11}, {19, 20}, {30, 40}}},
      {.value = {11, 20}, .expected = {{10, 11}, {30, 40}}},
      {.value = {11, 21}, .expected = {{10, 11}, {30, 40}}},
      {.value = {11, 29}, .expected = {{10, 11}, {30, 40}}},
      {.value = {11, 30}, .expected = {{10, 11}, {30, 40}}},
      {.value = {11, 31}, .expected = {{10, 11}, {31, 40}}},
      {.value = {11, 39}, .expected = {{10, 11}, {39, 40}}},
      {.value = {11, 40}, .expected = {{10, 11}}},
      {.value = {11, 41}, .expected = {{10, 11}}},
      {.value = {19, 19}, .expected = {{10, 20}, {30, 40}}},
      {.value = {19, 20}, .expected = {{10, 19}, {30, 40}}},
      {.value = {19, 21}, .expected = {{10, 19}, {30, 40}}},
      {.value = {19, 29}, .expected = {{10, 19}, {30, 40}}},
      {.value = {19, 30}, .expected = {{10, 19}, {30, 40}}},
      {.value = {19, 31}, .expected = {{10, 19}, {31, 40}}},
      {.value = {19, 39}, .expected = {{10, 19}, {39, 40}}},
      {.value = {19, 40}, .expected = {{10, 19}}},
      {.value = {19, 41}, .expected = {{10, 19}}},
      {.value = {20, 20}, .expected = {{10, 20}, {30, 40}}},
      {.value = {20, 21}, .expected = {{10, 20}, {30, 40}}},
      {.value = {20, 29}, .expected = {{10, 20}, {30, 40}}},
      {.value = {20, 30}, .expected = {{10, 20}, {30, 40}}},
      {.value = {20, 31}, .expected = {{10, 20}, {31, 40}}},
      {.value = {20, 39}, .expected = {{10, 20}, {39, 40}}},
      {.value = {20, 40}, .expected = {{10, 20}}},
      {.value = {20, 41}, .expected = {{10, 20}}},
      {.value = {21, 21}, .expected = {{10, 20}, {30, 40}}},
      {.value = {21, 29}, .expected = {{10, 20}, {30, 40}}},
      {.value = {21, 30}, .expected = {{10, 20}, {30, 40}}},
      {.value = {21, 31}, .expected = {{10, 20}, {31, 40}}},
      {.value = {21, 39}, .expected = {{10, 20}, {39, 40}}},
      {.value = {21, 40}, .expected = {{10, 20}}},
      {.value = {21, 41}, .expected = {{10, 20}}},
      {.value = {29, 29}, .expected = {{10, 20}, {30, 40}}},
      {.value = {29, 30}, .expected = {{10, 20}, {30, 40}}},
      {.value = {29, 31}, .expected = {{10, 20}, {31, 40}}},
      {.value = {29, 39}, .expected = {{10, 20}, {39, 40}}},
      {.value = {29, 40}, .expected = {{10, 20}}},
      {.value = {29, 41}, .expected = {{10, 20}}},
      {.value = {30, 30}, .expected = {{10, 20}, {30, 40}}},
      {.value = {30, 31}, .expected = {{10, 20}, {31, 40}}},
      {.value = {30, 39}, .expected = {{10, 20}, {39, 40}}},
      {.value = {30, 40}, .expected = {{10, 20}}},
      {.value = {30, 41}, .expected = {{10, 20}}},
      {.value = {31, 31}, .expected = {{10, 20}, {30, 40}}},
      {.value = {31, 39}, .expected = {{10, 20}, {30, 31}, {39, 40}}},
      {.value = {31, 40}, .expected = {{10, 20}, {30, 31}}},
      {.value = {39, 39}, .expected = {{10, 20}, {30, 40}}},
      {.value = {39, 40}, .expected = {{10, 20}, {30, 39}}},
      {.value = {39, 41}, .expected = {{10, 20}, {30, 39}}},
      {.value = {40, 40}, .expected = {{10, 20}, {30, 40}}},
      {.value = {40, 41}, .expected = {{10, 20}, {30, 40}}},
      {.value = {41, 41}, .expected = {{10, 20}, {30, 40}}},
  };
  for (const auto &test : kTestCases) {
    VLOG(1) << "remove: " << test.value << " expect: " << test.expected;
    UnsafeIntervalSet copy(init);
...
TEST(IntervalSetTest, SetDifferences) {
  const SetOperationTestData kTestCases[] = {
      ...
      {.a = {}, .b = {{5, 6}}, .c = {}},          // empty - anything = empty
      {.a = {}, .b = {{5, 6}, {7, 8}}, .c = {}},  // empty - anything = empty
      {.a = {{1, 2}}, .b = {}, .c = {{1, 2}}},    // anything - empty = (same)
      {.a = {{1, 2}, {7, 9}},
       .b = {},
       .c = {{1, 2}, {7, 9}}},  // anything - empty = (same)
      {.a = {{0, 100}},
       .b = {{30, 40}, {60, 70}},
       .c = {{0, 30}, {40, 60}, {70, 100}}},
      {.a = {{0, 50}}, .b = {{30, 40}, {60, 70}}, .c = {{0, 30}, {40, 50}}},
      {.a = {{50, 100}}, .b = {{30, 40}, {60, 70}}, .c = {{50, 60}, {70, 100}}},
      {.a = {{10, 20}, {30, 40}}, .b = {{5, 9}}, .c = {{10, 20}, {30, 40}}},
      {.a = {{1, 2}, {3, 4}, {5, 6}, {7, 8}},
       .b = {{2, 7}},
       .c = {{1, 2}, {7, 8}}},
      {.a = {{1, 2}, {3, 4}, {5, 6}, {7, 8}},
...
TEST(IntervalSetTest, SetUnions) {
  const SetOperationTestData kTestCases[] = {
      {.a = {}, .b = {}, .c = {}},  // empty U empty = empty
      {.a = {}, .b = {{3, 7}}, .c = {{3, 7}}},
      {.a = {{3, 7}}, .b = {{3, 7}}, .c = {{3, 7}}},
      {.a = {{4, 6}}, .b = {{3, 7}}, .c = {{3, 7}}},
      {.a = {{12, 14}}, .b = {{3, 7}}, .c = {{3, 7}, {12, 14}}},
      {.a = {{1, 3}}, .b = {{3, 7}}, .c = {{1, 7}}},
      {.a = {{1, 2}, {3, 4}, {5, 6}},
       .b = {{2, 3}, {4, 5}, {6, 7}},
       .c = {{1, 7}}},
      {.a = {{1, 2}, {3, 4}, {5, 6}}, .b = {{2, 7}}, .c = {{1, 7}}},
      {.a = {{1, 2}, {5, 6}},
       .b = {{3, 4}, {7, 8}},
       .c = {{1, 2}, {3, 4}, {5, 6}, {7, 8}}},
  };
...
TEST(IntervalSetTest, ComplementGeneral) {
  ...
  const ComplementTestData kTestCases[] = {
      ...
      {.value = {5, 11}, .expected = {{5, 10}}},
      {.value = {5, 20}, .expected = {{5, 10}}},
      {.value = {5, 21}, .expected = {{5, 10}, {20, 21}}},
      {.value = {5, 29}, .expected = {{5, 10}, {20, 29}}},
      {.value = {5, 30}, .expected = {{5, 10}, {20, 30}}},
      {.value = {5, 31}, .expected = {{5, 10}, {20, 30}}},
      {.value = {5, 39}, .expected = {{5, 10}, {20, 30}}},
      {.value = {5, 40}, .expected = {{5, 10}, {20, 30}}},
      {.value = {5, 41}, .expected = {{5, 10}, {20, 30}, {40, 41}}},
      {.value = {10, 11}, .expected = {}},
      {.value = {10, 20}, .expected = {}},
      {.value = {10, 21}, .expected = {{20, 21}}},
      {.value = {10, 29}, .expected = {{20, 29}}},
      {.value = {10, 30}, .expected = {{20, 30}}},
      {.value = {10, 31}, .expected = {{20, 30}}},
      {.value = {10, 39}, .expected = {{20, 30}}},
      {.value = {10, 40}, .expected = {{20, 30}}},
      {.value = {10, 41}, .expected = {{20, 30}, {40, 41}}},
      {.value = {20, 21}, .expected = {{20, 21}}},
      {.value = {20, 29}, .expected = {{20, 29}}},
      {.value = {20, 30}, .expected = {{20, 30}}},
      {.value = {20, 31}, .expected = {{20, 30}}},
      {.value = {20, 39}, .expected = {{20, 30}}},
      {.value = {20, 40}, .expected = {{20, 30}}},
      {.value = {20, 41}, .expected = {{20, 30}, {40, 41}}},
      {.value = {21, 29}, .expected = {{21, 29}}},
      {.value = {21, 30}, .expected = {{21, 30}}},
      {.value = {21, 31}, .expected = {{21, 30}}},
      {.value = {21, 39}, .expected = {{21, 30}}},
      {.value = {21, 40}, .expected = {{21, 30}}},
      {.value = {21, 41}, .expected = {{21, 30}, {40, 41}}},
      {.value = {29, 29}, .expected = {}},
      {.value = {29, 30}, .expected = {{29, 30}}},
      {.value = {29, 31}, .expected = {{29, 30}}},
      {.value = {29, 39}, .expected = {{29, 30}}},
      {.value = {29, 40}, .expected = {{29, 30}}},
      {.value = {29, 41}, .expected = {{29, 30}, {40, 41}}},
      {.value = {30, 30}, .expected = {}},
      {.value = {30, 31}, .expected = {}},
      {.value = {30, 39}, .expected = {}},
      {.value = {30, 40}, .expected = {}},
      {.value = {30, 41}, .expected = {{40, 41}}},
      {.value = {39, 39}, .expected = {}},
      {.value = {39, 40}, .expected = {}},
      {.value = {39, 41}, .expected = {{40, 41}}},
      {.value = {40, 40}, .expected = {}},
      {.value = {40, 41}, .expected = {{40, 41}}},
      {.value = {40, 45}, .expected = {{40, 45}}},
  };
  for (const auto &test : kTestCases) {
