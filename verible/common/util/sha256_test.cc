...
//
// std::string SslSHA256Digest(std::string_view content) {
...
TEST(Sha256, DigestsAreEqual) {
  static constexpr std::string_view kOpenSslSha256BananaDigest =
...
TEST(Sha256, NonAsciiDigestsAreEqual) {
  static constexpr std::string_view kOpenSslSha256JaBananaDigest =
...
TEST(Sha256, LargeInputDigestsAreEqual) {
  static constexpr std::string_view kLargeText = R"(
...
Abstract
  ...
  static constexpr std::string_view kOpenSslSha256LargeTextDigest =
...
TEST(Sha256, EmptyInputDigestsAreEqual) {
  static constexpr std::string_view kOpenSslSha256EmptyStringDigest =
...
TEST(Sha256, IncrementallyAddedDigestsAreEqual) {
  ...
  std::string actual = absl::BytesToHexString(std::string_view(
