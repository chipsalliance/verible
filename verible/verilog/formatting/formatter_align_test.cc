...
static constexpr FormatterTestCase kAlignFormatterTestCases[] = {
    ...
    {// parameterized module with 'list_of_param_assignments'
     .input = "module foo #(A = 2, AA = 22, AAA = 222);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
                 "    A   = 2,\n"
                 "    AA  = 22,\n"
    ...
    {// parameterized module with 'parameter_declaration'
     .input = "module foo #(parameter int a = 2, parameter int aa = 22);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
                 "    parameter int a  = 2,\n"
                 "    parameter int aa = 22\n"
    ...
    {// parameterized module with 'parameter_declaration' and comments
     .input = "module foo #(//comment\nparameter int a = 2, parameter int aa = "
              "22);\n"
              "endmodule\n",
    ...
    {// parameterized module with 'parameter_declaration' and trailing comments
     .input = "module foo #(parameter int a = 2,//comment\n parameter int aa = "
              "22);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'parameter_declaration' and pre-proc
     .input = "module foo #(parameter int a = 2,\n"
    ...
    {// parameterized module with 'parameter_declaration' and packed dimensions
     .input = "module foo #(parameter logic [3:0] a = 2, parameter logic "
              "[30:0] aa = "
              "22);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'parameter_declaration' and unpacked
     // dimensions
     .input = "module foo #(parameter logic a[3:0] = 2, parameter logic  aa "
              "[30:0] = "
              "22);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'local_parameter_declaration'
     .input = "module foo #(localparam int a = 2, localparam int aa = 22);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
                 "    localparam int a  = 2,\n"
    ...
    {// parameterized module with 'local_parameter_declaration' and trailing
     // comments
     .input = "module foo #(localparam int a = 2,//comment\n localparam int aa "
              "= 22);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'local_parameter_declaration' and pre-proc
     .input = "module foo #(localparam int a = 2,\n"
    ...
    {// parameterized module with 'local_parameter_declaration' and packed
     // dimensions
     .input = "module foo #(localparam logic [3:0] a = 2, localparam logic "
              "[30:0] aa = "
              "22);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'local_parameter_declaration' and unpacked
     // dimensions
     .input = "module foo #(localparam logic a[3:0] = 2, localparam logic  aa "
              "[30:0] = "
              "22);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'data_type list_of_param_assignments'
     .input = "module foo #( int a = 2,  real aa = 22, longint aaa = 222);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
                 "    int     a   = 2,\n"
                 "    real    aa  = 22,\n"
    ...
    {// parameterized module with 'data_type list_of_param_assignments' and
     // packed dimensions
     .input = "module foo #(bit [1:0] a = 2,  reg [12:0] aa = 22, logic "
              "[123:0] aaa = "
              "222);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'data_type list_of_param_assignments' and
     // unpacked dimensions
     .input = "module foo #(bit  a[1:0] = 2,  reg  aa[12:0] = 22, logic aaa "
              "[123:0]  = "
              "222);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'data_type list_of_param_assignments' and
     // trailing comments
     .input = "module foo #(type T = int, type TT = bit, //comment\n type TTT= "
              "C#(logic) );\n"
              "endmodule\n",
     .expected = "module foo #(\n"
                 "    type T   = int,\n"
    ...
    {// parameterized module with 'data_type list_of_param_assignments' and
     // packed dimensions
     .input = "module foo #(type T = int [3:0], type TT = bit [250:0]);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
                 "    type T  = int [  3:0],\n"
                 "    type TT = bit [250:0]\n"
                 ...
                 "endmodule\n"},
    {.input = "module foo #(type T = int, "
              "A = 2, int AA = 22, parameter AAA = 222, parameter longint AAAA "
              "= 2222, "
    ...
    {// parameterized module with built-in data type
     .input = "module foo #(int a = 2, real abc = 2234);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
                 "    int  a   = 2,\n"
                 "    real abc = 2234\n"
    ...
    {// parameterized module with type
     .input = "module foo #(type TYPE1 = int, type TYPE2 = boo);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
                 "    type TYPE1 = int,\n"
                 "    type TYPE2 = boo\n"
                 ");\n"
                 "endmodule\n"},
    {.input = "module foo#(localparam type TYPE1 = int, type TYPE22 = bool, "
              "parameter   "
              " type TYPE333 = real);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized module with 'data_type list_of_param_assignments' and 2D
     // packed dimensions
     .input = "module foo #(type T = int [3:0][123:0], type TT = bit "
              "[123:0][1:0]);\n"
              "endmodule\n",
     .expected = "module foo #(\n"
    ...
    {// parameterized class with 'list_of_param_assignments'
     .input = "class foo #(A = 2, AA = 22, AAA = 222);\n"
              "endclass\n",
     .expected = "class foo #(\n"
                 "    A   = 2,\n"
                 "    AA  = 22,\n"
    ...
    {// parameterized class with 'parameter_declaration'
     .input = "class foo #(parameter int a = 2, parameter int aa = 22);\n"
              "endclass\n",
     .expected = "class foo #(\n"
                 "    parameter int a  = 2,\n"
                 "    parameter int aa = 22\n"
    ...
    {// parameterized class with 'parameter_declaration' and pre-proc
     .input = "class foo #(parameter int a = 2,\n"
              "`ifdef MACRO parameter int aa = 22, `endif\n"
              "parameter int aaa = 222);\n"
              "endclass\n",
     .expected = "class foo #(\n"
    ...
    {// parameterized class with 'local_parameter_declaration'
     .input = "class foo #(localparam int a = 2, localparam int aa = 22);\n"
              "endclass\n",
     .expected = "class foo #(\n"
                 "    localparam int a  = 2,\n"
                 "    localparam int aa = 22\n"
    ...
    {// parameterized class with 'local_parameter_declaration' and trailing
     // comments
     .input = "class foo #(localparam int a = 2,//comment\n localparam int aa "
              "= 22);\n"
              "endclass\n",
     .expected = "class foo #(\n"
                 "    localparam int a  = 2,  //comment\n"
    ...
    {// parameterized class with 'local_parameter_declaration' and pre-proc
     .input = "class foo #(localparam int a = 2,\n"
              "`ifdef MACRO localparam int aa = 22, `endif\n"
              "localparam int aaa = 222);\n"
              "endclass\n",
     .expected = "class foo #(\n"
    ...
    {// parameterized class with 'local_parameter_declaration' and packed
     // dimensions
     .input = "class foo #(localparam logic [3:0] a = 2, localparam logic "
              "[30:0] aa = "
              "22);\n"
              "endclass\n",
     .expected = "class foo #(\n"
    ...
    {// parameterized class with 'local_parameter_declaration' and unpacked
     // dimensions
     .input = "class foo #(localparam logic a[3:0] = 2, localparam logic  aa "
              "[30:0] = "
              "22);\n"
              "endclass\n",
     .expected = "class foo #(\n"
    ...
    {// parameterized class with 'data_type list_of_param_assignments'
     .input = "class foo #( int a = 2,  real aa = 22, longint aaa = 222);\n"
              "endclass\n",
     .expected = "class foo #(\n"
                 "    int     a   = 2,\n"
                 "    real    aa  = 22,\n"
    ...
    {// parameterized class with 'data_type list_of_param_assignments' and
     // packed dimensions
     .input = "class foo #(bit [1:0] a = 2,  reg [12:0] aa = 22, logic [123:0] "
              "aaa = "
              "222);\n"
              "endclass\n",
     .expected = "class foo #(\n"
    ...
    {// parameterized class with 'data_type list_of_param_assignments' and
     // unpacked dimensions
     .input = "class foo #(bit  a[1:0] = 2,  reg  aa[12:0] = 22, logic aaa "
              "[123:0]  = "
              "222);\n"
              "endclass\n",
     .expected = "class foo #(\n"
    ...
    {// parameterized class with 'data_type list_of_param_assignments' and
     // trailing comments
     .input = "class foo #(type T = int, type TT = bit, //comment\n type TTT= "
              "C#(logic) "
              ");\n"
              "endclass\n",
     .expected = "class foo #(\n"
    ...
    {// parameterized class with 'data_type list_of_param_assignments' and
     // packed dimensions
     .input = "class foo #(type T = int [3:0], type TT = bit [250:0]);\n"
              "endclass\n",
     .expected = "class foo #(\n"
                 "    type T  = int [  3:0],\n"
                 "    type TT = bit [250:0]\n"
    ...
    {// parameterized class with built-in data type
     .input = "class foo #(int a = 2, real abc = 2234);\n"
              "endclass\n",
     .expected = "class foo #(\n"
                 "    int  a   = 2,\n"
                 "    real abc = 2234\n"
    ...
    {// parameterized class with type
     .input = "class foo #(type TYPE1 = int, type TYPE2 = boo);\n"
              "endclass\n",
     .expected = "class foo #(\n"
                 "    type TYPE1 = int,\n"
                 "    type TYPE2 = boo\n"
                 ");\n"
                 "endclass\n"},
    {.input = "class foo#(localparam type TYPE1 = int, type TYPE22 = bool, "
              "parameter    "
              "type TYPE333 = real);\n"
              "endclass\n",
     .expected = "class foo #(\n"
    ...
    {// parameterized interface with 'local_parameter_declaration'
     .input = "interface foo #(localparam int a = 2, localparam int aa = 22);\n"
              "endinterface\n",
    ...
    {// parameterized interface with 'local_parameter_declaration' and comments
     .input =
         ...
         "22);\n"
         "endinterface\n",
     .expected = "interface foo #(  //comment\n"
                 "    localparam int a  = 2,\n"
                 "    localparam int aa = 22\n"
                 ");\n"
                 "endinterface\n"},
    ...
    {// parameterized interface with 'local_parameter_declaration' and pre-proc
     .input = "interface foo #(localparam int a = 2,\n"
              "`ifdef MACRO localparam int aa = 22, `endif\n"
              "localparam int aaa = 222);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
    ...
    {// parameterized interface with 'local_parameter_declaration' and packed
     // dimensions
     .input = "interface foo #(localparam logic [3:0] a = 2, localparam logic "
              "[30:0] aa "
              "= 22);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
    ...
    {// parameterized interface with 'local_parameter_declaration' and unpacked
     // dimensions
     .input = "interface foo #(localparam logic a[3:0] = 2, localparam logic  "
              "aa [30:0] "
              "= 22);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments'
     .input = "interface foo #( int a = 2,  real aa = 22, longint aaa = 222);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
                 "    int     a   = 2,\n"
                 "    real    aa  = 22,\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments' and
     // comments
     .input = "interface foo #(//comment\nint a = 2,  shortreal aa = 22, "
              "longint aaa = "
              "222);\n"
              "endinterface\n",
     .expected = "interface foo #(  //comment\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments' and
     // trailing comments
     .input = "interface foo #(int a = 2,  shortreal aa = 22,//comment\n "
              "longint aaa = "
              "222);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments' and
     // packed dimensions
     .input = "interface foo #(bit [1:0] a = 2,  reg [12:0] aa = 22, logic "
              "[123:0] aaa "
              "= 222);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments' and
     // unpacked dimensions
     .input = "interface foo #(bit  a[1:0] = 2,  reg  aa[12:0] = 22, logic aaa "
              "[123:0]  "
              "= 222);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments' and
     // pre-proc
     .input = "interface foo #(type T = int,\n"
              "`ifdef MACRO type TT = bit, `endif\n"
              " type TTT= C#(logic));\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments' and
     // packed dimensions
     .input = "interface foo #(type T = int [3:0], type TT = bit [250:0]);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
                 "    type T  = int [  3:0],\n"
                 "    type TT = bit [250:0]\n"
    ...
    {// parameterized interface with built-in data type
     .input = "interface foo #(int a = 2, real abc = 2234);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
                 "    int  a   = 2,\n"
                 "    real abc = 2234\n"
    ...
    {// parameterized interface with type
     .input = "interface foo #(type TYPE1 = int, type TYPE2 = boo);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
                 "    type TYPE1 = int,\n"
                 "    type TYPE2 = boo\n"
                 ");\n"
                 "endinterface\n"},
    {.input = "interface foo#(localparam type TYPE1 = int, type TYPE22 = bool, "
              "parameter    type TYPE333 = real);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
                 "    localparam type TYPE1   = int,\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments' and
     ...
     .input = "interface foo #(parameter type T = int [3:0], type TT = bit "
              "[123:0]);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
                 "    parameter type T  = int [  3:0],\n"
    ...
    {// parameterized interface with 'data_type list_of_param_assignments' and
     ...
     .input = "interface foo #(type T = int [3:0][123:0], type TT = bit "
              "[123:0][1:0]);\n"
              "endinterface\n",
     .expected = "interface foo #(\n"
                 "    type T  = int [  3:0][123:0],\n"
    ...
    {// wildcard import package at module header
     .input = "module foo import bar::*; (baz); endmodule\n",
     .expected = "module foo\n"
                 "  import bar::*;\n"
                 "(\n"
                 "    baz\n"
    ...
    {// import package at module header
     .input = "module foo import bar::baz; (qux); endmodule\n",
     .expected = "module foo\n"
                 "  import bar::baz;\n"
                 "(\n"
                 "    qux\n"
    ...
    {// separate package import declarations in module header
     .input = "module foo import bar::*,baz::*; import q_pkg::qux; (qux); "
              "endmodule\n",
     .expected = "module foo\n"
                 "  import bar::*, baz::*;\n"
                 "  import q_pkg::qux;\n"
                 ...
                 "endmodule\n"},
    {// import package at module header
     .input = "module foo import bar::baz; #(int p = 3)(qux); endmodule\n",
     .expected = "module foo\n"
                 "  import bar::baz;\n"
                 "#(\n"
                 "    int p = 3\n"
    ...
    {.input =
     ...
     .expected = "function int foo(logic [31:0] data);\n"
                 "  return {<<8{data}};\n"
                 "endfunction\n"},
    {.input = "function int f;return(1);endfunction",
     .expected = "function int f;\n"
                 "  return (1);\n"
                 "endfunction\n"},
    {.input = "function int f;return-1;endfunction",
     .expected = "function int f;\n"
    ...
    {.input = "string abc[] = {\n"
     ...
     .expected = "string abc[] = {\"a\",\n"
                 ...
                 "                \"b\",\n"
                 "                \"c\"};\n"},
    {.input = "string numbers[] = {\"one\", \"two\", \"three\", \"four\"};\n",
     .expected = "string numbers[] = {\"one\",\n"
                 "                    \"two\",\n"
                 "                    \"three\",\n"
                 "                    \"four\"};\n"},
    {.input = "string numbers[] = {\"one\", \"two\", THREE, \"four\"};\n",
     .expected = "string numbers[] = {\n"
                 "  \"one\", \"two\", THREE, \"four\"\n"
                 "};\n"},
    {.input = "string numbers[] = {\"one\", {\"two\", \"three\"}, \"four\"};\n",
     .expected = "string numbers[] = {\n"
    ...
    {.input = "string numbers[] = {\"one\", {\"two\", //\n"
     ...
     .expected = "string numbers[] = {\n"
                 ...
                 "  \"four\"\n"
                 "};\n"},
    {.input = "string years[] = {\"two_thousand_nineteen\", "
              "\"two_thousand_twenty\",\n"
    ...
    {.input = "typedef struct {\n"
     ...
     .expected = "typedef struct {\n"
                 ...
                 "} type_t;\n"},
    {.input = "typedef union soft packed {\n"
              "bit [3:0] first; bit [31:0] second; generic_type_name_t third;\n"
              "} type_t;",
     .expected = "typedef union soft packed {\n"
                 "  bit [3:0]           first;\n"
                 "  bit [31:0]          second;\n"
                 "  generic_type_name_t third;\n"
                 "} type_t;\n"},
    {.input = "typedef union soft {\n"
              "bit [3:0] first; bit [31:0] second; generic_type_name_t third;\n"
              "} type_t;",
     .expected = "typedef union soft {\n"
                 "  bit [3:0]           first;\n"
                 "  bit [31:0]          second;\n"
                 "  generic_type_name_t third;\n"
                 "} type_t;\n"},
    ...
    {.input = "typedef struct packed {\n"
              ...
              "uint qq;\n"
              "} nested_qs_t;",
     .expected = "typedef struct packed {\n"
                 "  struct packed {\n"
                 "    bit   q;\n"
                 "    logic qq;\n"
                 "    logic qqq;\n"
    ...
    {.input = "typedef struct packed {\n"
     ...
     .expected = "typedef struct packed {\n"
                 ...
                 "  uint qq;\n"
                 "} nested_qs_t;\n"},
    {.input = "typedef struct {bit [3:0] first;\n"
              "`ifdef MACRO\n"
    ...
    {.input = "`define BAR 1 // A\n"
              "module foo(); // B\n"
              "wire baz;     // C\n"
              "endmodule:foo // D\n",
     .expected = "`define BAR 1 // A\n"
                 "module foo ();  // B\n"
                 "  wire baz;  // C\n"
                 "endmodule : foo  // D\n"},
    {.input = "`define BAR 1 // A\n"
    ...
    {.input = "module foo ();  // A\n"  // Starting comment; already on correct
                                        // column
              "                 // A.1\n"  // A's column + 1
              "               // A.2\n"    // A's column - 1
    ...
    // wrapped.
    {.input = "module foo(output logic very_very_very_very_long_name // A\n"
              "                                                      // A.1\n"
              "); endmodule\n",
     .expected = "module foo (\n"
                 "    output logic\n"
    ...
    {.input = "module m;\n"
     ...
     .expected = "module m;\n"
                 ...
                 "  ;\n"
                 "endmodule\n"},
    {.input = "assign foo = bar\n"
              "// comment\n"
              ";\n",
     .expected = "assign foo = bar\n"
                 "    // comment\n"
                 "    ;\n"},
    {.input = "assign foo = bar // comment\n"
              ";\n",
     .expected = "assign foo = bar  // comment\n"
                 ";\n"},
...
TEST(FormatterEndToEndTest, ParamDeclarationAlignmentFlushLeft) {
  static constexpr FormatterTestCase kTestCases[] = {
      ...
      {// interface context: flush-left
       .input = "interface my_if;\n"
                "localparam foo = 1;\n"
                "localparam barr = 2;\n"
                "endinterface\n",
       .expected = "interface my_if;\n"
                   "  localparam foo = 1;\n"
                   "  localparam barr = 2;\n"
                   "endinterface\n"},
  };
