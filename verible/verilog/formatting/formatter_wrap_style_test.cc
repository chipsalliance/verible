...
TEST(FormatterEndToEndTest, AutoInferAlignment) {
  static constexpr FormatterTestCase kTestCases[] = {
      ...
      {.input = "module  mm ;\n"
                "foo #(\n"
                ".a(a    ),\n"  // user manually triggers alignment with excess
                                // spaces
                ".bbcccc(bb)\n"
                ")bar( );\n"
                "endmodule:mm\n",
      ...
      {.input = "module m_assign;\n"
                "assign foo = 1'b1;\n"  // alignment adds few spaces, so align
                "assign baar = 1'b0;\n"
                "endmodule\n",
       .expected = "module m_assign;\n"
                   "  assign foo  = 1'b1;\n"  // aligned
                   "  assign baar = 1'b0;\n"
                   "endmodule\n"},
      {.input = "module m_assign;\n"
      ...
      {.input = "module  ma ;\n"
       ...
       .expected = "module ma;\n"
                   ...
                   "  end\n"
                   "endmodule\n"},
      {.input = "function void  fa ;\n"
                "c = 1'b0;\n"
                "aa = b;\n"
                "endfunction\n",
       .expected = "function void fa;\n"
                   "  c  = 1'b0;\n"  // only one space to align
                   "  aa = b;\n"
                   "endfunction\n"},
      {.input = "task  ta ; \n"
      ...
      {.input = "module  ma ;\n"
       ...
       .expected = "module ma;\n"
                   ...
                   "  end\n"
                   "endmodule\n"},
      {.input = "function int  fa ;\n"
                "c <= 1'b0;\n"
                "aa <= b;\n"
                "return 0 ;\n"
                "endfunction\n",
       .expected = "function int fa;\n"
                   "  c  <= 1'b0;\n"  // only one space to align
                   "  aa <= b;\n"
                   "  return 0;\n"
                   "endfunction\n"},
      ...
      {.input = "class  cc ;\n"
       ...
       .expected =
           ...
           "endclass : cc\n"},
      {.input = "class  cc ;\n"
                "int     my_int;\n"  // intentional excessive spaces, trigger
                                     // alignment
                "foo_pkg::bar_t my_bar;\n"
                "endclass:cc\n",
       .expected = "class cc;\n"
      ...
      {// small difference between flush-left and align, so align
       .input = "function f; case (x)kZZZZ  :if( b )break; default :return 2;"
                "endcase endfunction\n",
       .expected =
           "function f;\n"
           "  case (x)\n"
      ...
      {// small error relative to flush-left, so flush-left
       .input = "function f; case (x)kZ  :if( b )break; default :return 2;"
                "endcase endfunction\n",
       .expected = "function f;\n"
                   "  case (x)\n"
                   "    kZ: if (b) break;\n"  // flush-left
      ...
      {// induced alignment, with ignored comments
       .input = "function f; case (x)kZ  :if( b )break; \n//c1\n kXX: g = f; "
                "\n//c2\ndefault    :return 2;"
                "endcase endfunction\n",
       .expected = "function f;\n"
                   "  case (x)\n"
      ...
      {// case-inside: small difference between flush-left and align, so align
       .input = "function f; case (x)inside [0:3]  :yy=zzz; [4:11] :yy=zz;"
                "endcase endfunction\n",
       .expected = "function f;\n"
                   "  case (x) inside\n"
      ...
      {// case-inside: flush left
       .input = "function f; case (x)inside [0:3]  :yy=zzz; [4:999999] :yy=zz;"
                "endcase endfunction\n",
       .expected = "function f;\n"
                   "  case (x) inside\n"
                   "    [0 : 3]: yy = zzz;\n"  // flush-left
      ...
      {// case-generate: align would add few spaces, so align
       .input = "module mc ; case (x)kZ  : gg h(); kXYY :j kk();"
                "endcase endmodule\n",
       .expected = "module mc;\n"
                   "  case (x)\n"
                   "    kZ:   gg h ();\n"  // align
      ...
      {// case-generate + comment: align would add few spaces, so align
       .input = "module mc ; case (x)kZ  : gg h(); \n//c1\n kXYY :j kk();"
                "endcase endmodule\n",
       .expected = "module mc;\n"
                   "  case (x)\n"
                   "    kZ:   gg h ();\n"  // align
      ...
      {// case-generate: align would add too many space, so flush-left
       .input = "module mc ; case (x)kZ  : gg h(); kXYYYY :j kk();"
                "endcase endmodule\n",
       .expected = "module mc;\n"
                   "  case (x)\n"
                   "    kZ: gg h ();\n"  // flush-left
      ...
      {// randcase: align (small difference from flush-left)
       .input = "task trc  ;randcase 10: x = 1; 1: x = 3; endcase endtask",
       .expected = "task trc;\n"
                   "  randcase\n"
                   "    10: x = 1;\n"
                   "    1:  x = 3;\n"  // aligned
      ...
      {// randcase: inferred flush-left
       .input = "task trc  ;randcase 10000: x = 1; 1: x = 3; endcase endtask",
       .expected = "task trc;\n"
                   "  randcase\n"
                   "    10000: x = 1;\n"
                   "    1: x = 3;\n"
...
static constexpr FormatterTestCase kFormatterWideTestCases[] = {
    // specify blocks
    {.input = "module  specify_tests ;\n"
              "specify\n"  // empty list
              "endspecify\n"
              "endmodule",
     .expected = "module specify_tests;\n"
                 "  specify\n"
                 "  endspecify\n"
                 "endmodule\n"},
    {.input = "module  specify_tests ;\n"
  ...
  static constexpr FormatterTestCase kTestCases[] = {
      ...
      {// example with two ports
       .input = "module  m   (\n"
                ...
                "  endmodule\n",
       .expected = "module m (\n"
                   "    input  clk,\n"  // indented, but internal pre-existing
                                        // spacing preserved
                   "    output bar\n"
                   ");\n"
                   "endmodule\n"},
...
TEST(FormatterEndToEndTest, DisableTryWrapLongLines) {
  static constexpr FormatterTestCase kTestCases[] = {
      ...
      {.input = "function void f();\n"
                "for (int i = N; i > 0; i--) begin\n"
                "end\n"
                "endfunction\n",
       .expected = "function void f();\n"
                   "  for (int i = N; i > 0; i--) begin\n"
                   "  end\n"
                   "endfunction\n"},
      {.input = "function void f();"
       ...
       .expected = "function void f();\n"
                   ...
                   "  end\n"
                   "endfunction\n"},
      {.input = "function void f();"  // newlines absent from input
  ...
  static constexpr FormatterTestCase kTestCases[] = {
      ...
      {// example with two ports
       ...
       .expected = "module m (\n"
                   ...
                   "endmodule\n"},
      {// interface example
       .input = "interface  handshake   (\n"
                "wire req,\n"
                "wire ack\n"
                ")\t;\n"
                "  endinterface\n",
       .expected = "interface handshake (\n"
                   "  wire req,\n"  // indented 2 spaces
                   "  wire ack\n"
                   ");\n"
                   "endinterface\n"},
  ...
  static constexpr FormatterTestCase kTestCases[] = {
      ...
      {// typedef with two parameters
       .input = "typedef \n"
                ...
                ".W(2),.L(4)"
                ") baz;\n",
       .expected = "typedef foo_pkg::bar_t#(\n"
                   "  .W(2),\n"  // indent +2 spaces only
                   "  .L(4)\n"
                   ") baz;\n"},
  };
...
TEST(FormatterEndToEndTest, SelectLines) {
  const SelectLinesTestCase kTestCases[] = {
      ...
      {.input = "", .lines = {{1, 2}}, .expected = ""},
      {// expect all three lines for format
       .input = "  parameter    int foo_line1 =     0 ;\n"
                "  parameter    int foo_line2 =     0 ;\n"
                "  parameter    int foo_line3 =     0 ;\n",
       .lines = {},
       .expected = "parameter int foo_line1 = 0;\n"
                   "parameter int foo_line2 = 0;\n"
                   "parameter int foo_line3 = 0;\n"},
      ...
      {.input = "module m;\n"
                "  if (foo) begin:l1\n"
                "    if (foo) begin:l2\n"
                "      always_comb\n"  // normally this line and next would fit
                                       // together
      ...
      {.input =
           ...
           ");\n"
           "endmodule:m\n",
       .lines = {{3, 4}},  // format incrementally
       .expected = "module m(\n"
                   "  input wire f,\n"
      ...
      {.input = "module m(\n"
                ...
                ");\n"
                "endmodule:m\n",
       .lines = {{2, 3}},  // format incrementally
       .expected = "module m(\n"
                   "    input  wire   f,\n"  // "new line" indented, but other
                                             // spaces kept
                   "  input  foo::bar  ggg\n"
                   ");\n"
                   "endmodule:m\n"},
...
TEST(FormatterEndToEndTest, PreserveVSpacesOnly) {
  static constexpr FormatterTestCase kTestCases[] = {
      ...
      {.input = "module foo;wire w;endmodule\n",
       .expected = "module foo;\n  wire w;\nendmodule\n"},
      {.input = "  module   foo  ;wire    w  ;endmodule  \n  ",
       .expected = "module foo;\n  wire w;\nendmodule\n"},
      {.input = "\nmodule\nfoo\n;\nwire\nw\n;endmodule\n\n",
...
static constexpr FormatterTestCase kFormatterTestCasesElseStatements[] = {
    ...
    {.input =
     ...
     .expected = "module m;\n"
                 ...
                 "  ;\n"  // stray ';'
                 "endmodule\n"},
    {.input = "module m;initial begin if(a==b)"
              "c.d(e);else\n"
              "f.g(h);end endmodule",
     .expected = "module m;\n"
                 "  initial begin\n"
                 ...
                 "  end\n"
                 "endmodule\n"},
    {.input = "   module m;  always_comb    begin     \n"
              "        if      ( a   ) b =  16'hdead    ; \n"
    ...
    {.input = "module foo();\n"
              "always_comb begin\n"
              "value = function_name(.long_parameter(8'hA), "
...
TEST(FormatterEndToEndTest, ConstraintExpressions) {
  static constexpr FormatterTestCase kTestCases[] = {
      ...
      {.input = "constraint xx { if (a) b; }\n",
       .expected = "constraint xx {if (a) b;}\n"},

      {.input = "constraint xx { if (a) {b;} }\n",
       .expected = "constraint xx {\n"
                   "  if (a) {\n"
                   "    b;\n"
                   "  }\n"
                   "}\n"},
      ...
      {.input = "constraint yy { a == b;c==d;}",
       .expected = "constraint yy {\n"
                   "  a == b;\n"
                   "  c == d;\n"
                   "}\n"},

      // one-line constraints
      {.input = "constraint only_vec_instr_c {soft only_vec_instr == 0;}",
       .expected = "constraint only_vec_instr_c {soft only_vec_instr == 0;}\n"},
      ...
      {.input = "constraint c_operation{  if(fixed_operation_en){"
                "aes_operation == fixed_operation"
                ";}}",
       .expected = "constraint c_operation {\n"
      ...
      {.input = "constraint c_iv {if (fixed_iv_en) {aes_iv == fixed_iv};}",
       .expected = "constraint c_iv {\n"
                   "  if (fixed_iv_en)\n"
                   "  {aes_iv == fixed_iv};\n"
                   "}\n"},
...
static constexpr FormatterTestCase kFormatterTestCasesEnumDeclarations[] = {
    ...
    {.input = "typedef enum { kA=1, kAB=2, kABC=3} x;",
    ...
    {.input = "typedef enum { kA=1, kAB=2, kABCDEFGHIJKLMN=3} x;",
     .expected = "typedef enum {\n"
                 "  kA = 1,\n"
                 "  kAB = 2,\n"
                 "  kABCDEFGHIJKLMN = 3\n} x;\n"},
    ...
    {.input = "typedef enum { kA=1,// value kA\n"
              "// hello world\n"
              "kAB=2,// value kAB\n"
              "kABC=3// value kABC\n"
              "} x;",
    ...
    {.input = "typedef enum { kA=1, kAB=10, kABC=100} x;",
     .expected = "typedef enum {\n"
                 "  kA   = 1,\n"
                 "  kAB  = 10,\n"
                 "  kABC = 100\n} x;\n"},
...
static constexpr FormatterTestCase kOnelineFormatReferenceTestCases[] = {
    {// Coverpoint that could fit on one line
     .input = "covergroup memory @ (posedge ce); a :coverpoint d {"
              "bins l={0};} endgroup\n",
     .expected = "covergroup memory @(posedge ce);\n"
...
static constexpr DimensionsAlignmentTestCase
    kPortDeclarationDimensionsAlignmentTestCases[] = {
        {.input = "import \"DPI-C\" context function void func(\n"
                  "input bit foo,\n"
                  "input bit [2] foobar,\n"
                  "input bit [24:16] bar,\n"
         ...
         .expected =
             {
                 ...
                 "  input  bit [     4][ 24:0][16:0] foobarbaz         [     "
                 "],\n"
                 "  input  bit [FOOBAZ][31:24]       qux               [   "
                 "16],\n"
                 "  input  bit [    16]              quux     [8:2][16][   "
                 "32],\n"
                 "  output bit [   2:0][  2:0][ 2:0] quuz          [ "
                 "8][16:12]\n"
                 ");\n",
                 "import \"DPI-C\" context function void func(\n"
                 "  input  bit                      foo,\n"
...
static constexpr FormatterTestCase kNestedFunctionsTestCases40ColumnsLimit[] = {
    {.input = "module foo;"
     ...
     .expected =
         ...
         "endmodule\n"},
    {.input = "module foo;`uvm_info(`gfn, $sformatf("
...
static constexpr FormatterTestCase kNestedFunctionsTestCases80ColumnsLimit[] = {
    ...
    {.input = "module x;"
     ...
     .expected = "module x;\n"
                 ...
                 "      `gfn,\n"
                 "      $sformatf(\n"
                 "          \"The data 0x%0h written to the signature address "
                 "is formatted "
                 "incorrectly.\",\n"
                 "          signature_data))\n"
                 "endmodule\n"},
